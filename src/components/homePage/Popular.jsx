  ...
  useEffect(() => {
    if (fetchedTestimonials && fetchedTestimonials.length > 0) {
      ...
      const mappedTestimonials = fetchedTestimonials.map((item) => {
        ...
        const role = nameMatch ? nameMatch[1].trim() : (item.name || "Anonymous");
      ...
      <div className="px-4 md:px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-base text-slate-600">
            Stories from members across regions highlight how Jasmina keeps
            professional journeys safe, inclusive, and grounded in trust.
          </p>
        </div>
        ...
        <div className="relative mt-16 px-2 sm:px-6 lg:px-10">
          {isLoading ? (
            ...
            <div className="text-center py-12">
              <p className="text-lg text-slate-500">No testimonials available at the moment.</p>
            </div>
          ) : (
            <Swiper
                    ...
                    <div className="relative flex h-full min-h-[240px] flex-col justify-between gap-4">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-lg font-semibold text-slate-900">{testimonial.region || "N/A"}</p>
                        </div>
                      </div>
